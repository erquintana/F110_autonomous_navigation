...
gnome-terminal --window -e "docker run -it --name=f1tenth_gym_container --rm --net=host f1tenth_gym" --tab -e "roslaunch f1tenth_gym_ros simulate_F110_ackerman.launch" 
