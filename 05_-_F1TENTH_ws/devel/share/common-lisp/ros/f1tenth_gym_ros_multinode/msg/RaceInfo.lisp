...
(cl:in-package f1tenth_gym_ros_multinode-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <RaceInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RaceInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenth_gym_ros_multinode-msg:<RaceInfo> is deprecated: use f1tenth_gym_ros_multinode-msg:RaceInfo instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <RaceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_gym_ros_multinode-msg:header-val is deprecated.  Use f1tenth_gym_ros_multinode-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'ego_lap_count-val :lambda-list '(m))
(cl:defmethod ego_lap_count-val ((m <RaceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_gym_ros_multinode-msg:ego_lap_count-val is deprecated.  Use f1tenth_gym_ros_multinode-msg:ego_lap_count instead.")
  (ego_lap_count m))

(cl:ensure-generic-function 'opp_lap_count-val :lambda-list '(m))
(cl:defmethod opp_lap_count-val ((m <RaceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_gym_ros_multinode-msg:opp_lap_count-val is deprecated.  Use f1tenth_gym_ros_multinode-msg:opp_lap_count instead.")
  (opp_lap_count m))

(cl:ensure-generic-function 'ego_elapsed_time-val :lambda-list '(m))
(cl:defmethod ego_elapsed_time-val ((m <RaceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_gym_ros_multinode-msg:ego_elapsed_time-val is deprecated.  Use f1tenth_gym_ros_multinode-msg:ego_elapsed_time instead.")
  (ego_elapsed_time m))

(cl:ensure-generic-function 'opp_elapsed_time-val :lambda-list '(m))
(cl:defmethod opp_elapsed_time-val ((m <RaceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_gym_ros_multinode-msg:opp_elapsed_time-val is deprecated.  Use f1tenth_gym_ros_multinode-msg:opp_elapsed_time instead.")
  (opp_elapsed_time m))

(cl:ensure-generic-function 'ego_collision-val :lambda-list '(m))
(cl:defmethod ego_collision-val ((m <RaceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_gym_ros_multinode-msg:ego_collision-val is deprecated.  Use f1tenth_gym_ros_multinode-msg:ego_collision instead.")
  (ego_collision m))

(cl:ensure-generic-function 'opp_collision-val :lambda-list '(m))
(cl:defmethod opp_collision-val ((m <RaceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_gym_ros_multinode-msg:opp_collision-val is deprecated.  Use f1tenth_gym_ros_multinode-msg:opp_collision instead.")
  (opp_collision m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RaceInfo>)))
  ...
  "f1tenth_gym_ros_multinode/RaceInfo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RaceInfo)))
  "Returns string type for a message object of type 'RaceInfo"
  "f1tenth_gym_ros_multinode/RaceInfo")
